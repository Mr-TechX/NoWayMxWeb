  ...
  (window.lightcase = {
      ...
      (lightcase.settings = e.extend(
        !0,
        {
          ...
          errorMessage: function () {
            return (
              '<p class="' +
              lightcase.settings.classPrefix +
              'error">' +
          ...
          markup: function () {
            e("body").append(
              ($overlay = e(
                '<div id="' + lightcase.settings.idPrefix + 'overlay"></div>'
              )),
              ($loading = e(
                '<div id="' +
                  lightcase.settings.idPrefix +
                  'loading" class="' +
                  lightcase.settings.classPrefix +
                  'icon-spin"></div>'
              )),
              ...
              $case.after(
                ($nav = e(
                  '<div id="' + lightcase.settings.idPrefix + 'nav"></div>'
                ))
              ),
              $nav.append(
                ($close = e(
                ...
                ($prev = e(
                  '<a href="#" class="' +
                    lightcase.settings.classPrefix +
                    'icon-prev"><span>' +
                    lightcase.labels["navigator.prev"] +
                    "</span></a>"
                ).hide()),
                ($next = e(
                  '<a href="#" class="' +
                    lightcase.settings.classPrefix +
                    'icon-next"><span>' +
                    lightcase.labels["navigator.next"] +
                    "</span></a>"
                ).hide()),
                ($play = e(
                  '<a href="#" class="' +
                    lightcase.settings.classPrefix +
                    'icon-play"><span>' +
                    lightcase.labels["navigator.play"] +
                    "</span></a>"
                ).hide()),
                ($pause = e(
                  '<a href="#" class="' +
                    lightcase.settings.classPrefix +
                    'icon-pause"><span>' +
                    lightcase.labels["navigator.pause"] +
                    "</span></a>"
                ).hide())
              ),
              $case.append(
    ...
    getObjectData: function (t) {
      var i = {
        ...
        url: lightcase.verifyDataUrl(
          lightcase.settings.href || t.attr("data-href") || t.attr("href")
        ),
        ...
        rel: t.attr("data-rel"),
        type:
          lightcase.settings.type ||
          lightcase.verifyDataType(t.attr("data-href") || t.attr("href")),
        isPartOfSequence: lightcase.isPartOfSequence(t.attr("data-rel"), ":"),
        isPartOfSequenceWithSlideshow: lightcase.isPartOfSequence(
          t.attr("data-rel"),
          ":slideshow"
        ),
      ...
      return (
        (i.sequenceInfo =
          i.currentIndex +
          1 +
          lightcase.labels["sequenceInfo.of"] +
          i.sequenceLength),
        i
      );
    },
    isPartOfSequence: function (t, i) {
      var s = e('[data-rel="' + t + '"]'),
        a = new RegExp(i);
      return a.test(t) && s.length > 1 ? !0 : !1;
    },
    isSlideshowEnabled: function () {
      return !lightcase.objectData.isPartOfSequence ||
        (lightcase.settings.slideshow !== !0 &&
          lightcase.objectData.isPartOfSequenceWithSlideshow !== !0)
        ? !1
        : !0;
    },
      ...
      switch (lightcase.objectData.type) {
        ...
        case "inline":
          (t = e(
            ...
            t.html(lightcase.cloneObject(e(lightcase.objectData.url))),
            e.each(lightcase.settings.inline, function (e, i) {
              t.attr("data-" + e, i);
            });
          break;
        case "ajax":
          (t = e(
            ...
            e.each(lightcase.settings.ajax, function (e, i) {
        ...
        case "flash":
          (t = e(
            '<embed src="' +
              lightcase.objectData.url +
              '" type="application/x-shockwave-flash"></embed>'
          )),
            e.each(lightcase.settings.flash, function (e, i) {
              t.attr(e, i);
            });
          break;
        case "video":
          (t = e("<video></video>")),
            t.attr("src", lightcase.objectData.url),
            e.each(lightcase.settings.video, function (e, i) {
              t.attr(e, i);
            });
          break;
        default:
    ...
    addObject: function (e) {
      $contentInner.html(e),
        ...
        lightcase.settings.showSequenceInfo === !0 &&
        lightcase.objectData.isPartOfSequence
          ? ($sequenceInfo.html(lightcase.objectData.sequenceInfo),
            $sequenceInfo.show())
          : ($sequenceInfo.empty(), $sequenceInfo.hide()),
        lightcase.settings.showTitle === !0 &&
        void 0 !== lightcase.objectData.title &&
        "" !== lightcase.objectData.title
          ? ($title.html(lightcase.objectData.title), $title.show())
          : ($title.empty(), $title.hide()),
        lightcase.settings.showCaption === !0 &&
        void 0 !== lightcase.objectData.caption &&
        "" !== lightcase.objectData.caption
          ? ($caption.html(lightcase.objectData.caption), $caption.show())
          : ($caption.empty(), $caption.hide());
    },
    loadObject: function (t) {
      switch (lightcase.objectData.type) {
        case "inline":
          e(lightcase.objectData.url)
            ? lightcase.showContent(t)
            : lightcase.error();
          break;
        case "ajax":
          e.ajax(
            e.extend({}, lightcase.settings.ajax, {
              ...
              success: function (e) {
                "json" === lightcase.objectData.requestDataType
                  ? (lightcase.objectData.data = e)
                  : t.html(e),
                  lightcase.showContent(t);
              },
              error: function () {
        ...
        case "flash":
          ...
          break;
        case "video":
          "function" == typeof t.get(0).canPlayType ||
          0 === $case.find("video").length
            ? lightcase.showContent(t)
            : lightcase.error();
          break;
        default:
    ...
    error: function () {
      ...
      var t = e(
        '<div class="' + lightcase.settings.classPrefix + 'inlineWrap"></div>'
      );
      t.html(lightcase.settings.errorMessage),
        $contentInner.html(t),
    ...
    calculateDimensions: function (e) {
      ...
      var t = {
        ...
        maxWidth: parseInt(
          lightcase.dimensions.windowWidth * lightcase.settings.shrinkFactor
        ),
        maxHeight: parseInt(
          lightcase.dimensions.windowHeight * lightcase.settings.shrinkFactor
        ),
      };
      if (!lightcase.settings.disableShrink)
        switch (
          (t.maxWidth > lightcase.settings.maxWidth &&
            (t.maxWidth = lightcase.settings.maxWidth),
          t.maxHeight > lightcase.settings.maxHeight &&
            (t.maxHeight = lightcase.settings.maxHeight),
          ...
          lightcase.objectData.type)
        ) {
          case "image":
          case "flash":
          case "video":
            t.differenceWidthAsPercent > 100 &&
              t.differenceWidthAsPercent > t.differenceHeightAsPercent &&
              ((t.objectWidth = t.maxWidth),
              (t.objectHeight = parseInt(
                (t.objectHeight / t.differenceWidthAsPercent) * 100
              ))),
              t.differenceHeightAsPercent > 100 &&
                t.differenceHeightAsPercent > t.differenceWidthAsPercent &&
                ((t.objectWidth = parseInt(
                  (t.objectWidth / t.differenceHeightAsPercent) * 100
                )),
                (t.objectHeight = t.maxHeight)),
              t.differenceHeightAsPercent > 100 &&
                t.differenceWidthAsPercent < t.differenceHeightAsPercent &&
                ((t.objectWidth = parseInt(
                  (t.maxWidth / t.differenceHeightAsPercent) *
          ...
          case "error":
            ...
            break;
          default:
            (isNaN(t.objectWidth) || t.objectWidth > t.maxWidth) &&
              !lightcase.settings.forceWidth &&
              (t.objectWidth = t.maxWidth),
              ((isNaN(t.objectHeight) && "auto" !== t.objectHeight) ||
                t.objectHeight > t.maxHeight) &&
                !lightcase.settings.forceHeight &&
                (t.objectHeight = t.maxHeight);
        }
    ...
    adjustDimensions: function (e, t) {
      e.css({
        ...
        "max-width": e.attr("data-max-width")
          ? e.attr("data-max-width")
          : t.maxWidth,
        "max-height": e.attr("data-max-height")
          ? e.attr("data-max-height")
          : t.maxHeight,
      }),
        $contentInner.css({
          width: e.outerWidth(),
        ...
        $case.css({ width: $contentInner.outerWidth() }),
        $case.css({
    ...
    addElements: function () {
      e('[id^="' + lightcase.settings.idPrefix + '"]').length ||
        lightcase.settings.markup();
    },
    showContent: function (e) {
      switch (
        ($case.attr("data-type", lightcase.objectData.type),
        (lightcase.cache.object = e),
        lightcase.calculateDimensions(e),
        lightcase.callHooks(lightcase.settings.onFinish),
        lightcase.settings.transitionIn)
      ) {
        case "scrollTop":
        case "scrollRight":
        case "scrollBottom":
        ...
        case "scrollVertical":
          lightcase.transition.scroll($case, "in", lightcase.settings.speedIn),
            lightcase.transition.fade(
              $contentInner,
              "in",
              lightcase.settings.speedIn
            );
          break;
        case "elastic":
          $case.css("opacity") < 1 &&
      ...
      switch (((lightcase.busy = !0), lightcase.settings.transitionOut)) {
        ...
        case "scrollHorizontal":
          $case.is(":hidden")
            ...
            : lightcase.transition.scroll(
                $case,
                "out",
                lightcase.settings.speedOut,
                function () {
                  lightcase.loadContent();
                }
              );
    ...
    handleEvents: function () {
      lightcase.unbindEvents(),
        ...
        lightcase.isSlideshowEnabled() &&
          ($nav.hasClass(lightcase.settings.classPrefix + "paused")
            ? lightcase.stopTimeout()
            : lightcase.startTimeout()),
        lightcase.settings.liveResize && e(window).resize(lightcase.resize),
        $close.click(function (e) {
          e.preventDefault(), lightcase.lightcaseClose();
        }),
        lightcase.settings.closeOnOverlayClick === !0 &&
          $overlay.css("cursor", "pointer").click(function (e) {
            e.preventDefault(), lightcase.lightcaseClose();
          }),
        lightcase.settings.useKeys === !0 && lightcase.addKeyEvents(),
        lightcase.objectData.isPartOfSequence &&
          ($nav.attr("data-ispartofsequence", !0),
          ...
          lightcase.settings.swipe === !0 &&
            (e.isPlainObject(e.event.special.swipeleft) &&
              $case.on("swipeleft", function (e) {
                e.preventDefault(),
                  $next.click(),
                  lightcase.isSlideshowEnabled() && lightcase.stopTimeout();
              }),
            e.isPlainObject(e.event.special.swiperight) &&
              $case.on("swiperight", function (e) {
                e.preventDefault(),
                  $prev.click(),
                  lightcase.isSlideshowEnabled() && lightcase.stopTimeout();
              })));
    ...
    setNavigation: function () {
      var t = e('[data-rel="' + lightcase.objectData.rel + '"]'),
        ...
        c = { $prevItem: t.eq(s), $nextItem: t.eq(a) };
      return (
        i > 0 ? $prev.show() : (c.$prevItem = t.eq(n)),
        n >= a ? $next.show() : (c.$nextItem = t.eq(0)),
        lightcase.settings.navigateEndless === !0 &&
          ($prev.show(), $next.show()),
        c
      );
    },
    cloneObject: function (e) {
      ...
      return (
        e.is(":hidden")
          ? (lightcase.cacheObjectData(e),
            e.attr("id", lightcase.settings.idPrefix + "temp-" + i).empty())
          : t.removeAttr("id"),
        t.show()
      );
    },
    ...
    isTransitionSupported: function () {
      ...
      for (var a in s)
        s.hasOwnProperty(a) &&
          a in t.style &&
          ((lightcase.support.transition = s[a]), (i = !0));
      return i;
    },
    transition: {
      fade: function (e, t, i, s, a) {
        ...
        (lightcase.open || !n) &&
          ...
          (o.opacity = r),
          e.css(c).show(),
          lightcase.support.transitions
            ? ((o[lightcase.support.transition + "transition"] = i + "ms ease"),
              setTimeout(function () {
                e.css(o),
                  setTimeout(function () {
                    e.css(lightcase.support.transition + "transition", ""),
                      !a || (!lightcase.open && n) || a();
                  }, i);
              }, 15))
            : (e.stop(), e.animate(o, i, a)));
      },
      scroll: function (e, t, i, s) {
        var a = "in" === t,
          n = a
            ? lightcase.settings.transitionIn
            : lightcase.settings.transitionOut,
          c = "left",
          l = {},
          o = a ? 0 : 1,
          r = a ? "-50%" : "50%",
        ...
        if (lightcase.open || !a) {
          ...
          (l.opacity = o),
            ...
            e.css(l).show(),
            lightcase.support.transitions
              ? ((h[lightcase.support.transition + "transition"] =
                  i + "ms ease"),
                setTimeout(function () {
                  e.css(h),
                    setTimeout(function () {
      ...
      zoom: function (e, t, i, s) {
        ...
        (lightcase.open || !a) &&
          ((n.opacity = c),
          (n[lightcase.support.transition + "transform"] = l),
          (o.opacity = r),
          e.css(n).show(),
          lightcase.support.transitions
            ? ((o[lightcase.support.transition + "transform"] = h),
              (o[lightcase.support.transition + "transition"] = i + "ms ease"),
              setTimeout(function () {
                e.css(o),
                  setTimeout(function () {
                    e.css(lightcase.support.transition + "transform", ""),
                      e.css(lightcase.support.transition + "transition", ""),
                      !s || (!lightcase.open && a) || s();
                  }, i);
              }, 15))
            : (e.stop(), e.animate(o, i, s)));
      },
    },
    ...
    cacheObjectData: function (t) {
      e.data(t, "cache", { id: t.attr("id"), content: t.html() }),
        (lightcase.cache.originalObject = t);
    },
    restoreObject: function () {
      var t = e('[id^="' + lightcase.settings.idPrefix + 'temp-"]');
      t.attr("id", e.data(lightcase.cache.originalObject, "cache").id),
        t.html(e.data(lightcase.cache.originalObject, "cache").content);
    },
    resize: function () {
      lightcase.open &&
        (lightcase.isSlideshowEnabled() && lightcase.stopTimeout(),
    ...
    switchToFullScreenMode: function () {
      (lightcase.settings.shrinkFactor = 1),
        ...
        e("html").addClass(lightcase.settings.classPrefix + "fullScreenMode");
    },
    lightcaseOpen: function () {
      switch (
        ((lightcase.open = !0),
        (lightcase.support.transitions = lightcase.settings.cssTransitions
          ? lightcase.isTransitionSupported()
          : !1),
        (lightcase.support.mobileDevice = lightcase.isMobileDevice()),
        lightcase.support.mobileDevice &&
          (e("html").addClass(
            lightcase.settings.classPrefix + "isMobileDevice"
          ),
          lightcase.settings.fullScreenModeForMobile &&
        ...
        case "scrollHorizontal":
          $case.is(":hidden") &&
            ...
            lightcase.transition.fade(
              ...
              "in",
              lightcase.settings.speedIn,
              lightcase.settings.overlayOpacity,
              function () {
                lightcase.transition.fade(
                  $close,
                  "in",
      ...
      e("html").addClass(lightcase.settings.classPrefix + "open"),
    ...
    lightcaseClose: function () {
      switch (
        ...
        $loading.hide(),
        lightcase.unbindEvents(),
        e(window).off("resize", lightcase.resize),
        e("html").removeClass(lightcase.settings.classPrefix + "open"),
    ...
    cleanupDimensions: function () {
      ...
      $case.css({
        ...
        $contentInner.removeAttr("style").css("opacity", e),
    ...
    (e.fn.lightcase = function (t) {
      return lightcase[t]
        ? lightcase[t].apply(this, Array.prototype.slice.call(arguments, 1))
        : "object" != typeof t && t
        ? void e.error("Method " + t + " does not exist on jQuery.lightcase")
        : lightcase.init.apply(this, arguments);
    });
})(jQuery);
